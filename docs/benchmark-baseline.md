# Original SDK baseline

This archived report covers SDK commit `7ad464c`, before direct JavaScript delivery and missing-finish repair. [Current comparison](./benchmark).
